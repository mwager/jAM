...
public class TuneChangeEvent extends EventObject {
	 ...
	 * @param newTuneNotation
	 *            The notation of the tune that has been changed, removed or
	 *            added.
	 */
	public TuneChangeEvent(Object source, int eventType, Tune newTune,
			String newTuneNotation) {
		super(source);
