...
/**
 * This class provides parser instances that reduce the parsing scope to tunes
 * headers (music is excluded). This results in a much faster parsing than
 * parsing the whole tunes and enables you to build up tunes indexes fastly.<BR/>
 * Just invoke the usual methods {@link #parseFile(java.io.File)} or
 * {@link #parseFile(java.io.Reader)} and you'll get in return instances of Tune
 * without any music part.
 */
public class AbcHeadersParser extends AbcFileParser {
	...
	/**
	 * Overrides the standard definition of an abc-line ::= (1*element
	 * line-ender) / mid-tune-field / tex-command and replaces it as "text" to
	 * accelerate the parsing and avoid retrieving tokens from this part.
	 */
