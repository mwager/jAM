 ...
 */
public class PositionableMultiNote extends MultiNote implements
	...
	public PositionableMultiNote(Vector notes) {
		...
		PositionableNote lastNote = (PositionableNote) notes.elementAt(notes
				.size() - 1);
		m_position = firstNote.getPosition();
		m_length = lastNote.getPosition().getCharactersOffset()
				- firstNote.getPosition().getCharactersOffset()
				+ lastNote.getLength();
	}
