...
class AbcTextField {
	...
	public static final AbcTextReplacements bundle = AbcTextReplacements
			.getInstance();
	...
	/**
	 * Sets the text replacing all escaped combination to unicode char, e.g.
	 * <TT>\^a</TT> is replace by <TT>â</TT>
	 * 
	 * @param text
	 */
