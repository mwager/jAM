...
/**
 * This class defines all types of token that can be encountered while parsing a
 * tune written using abc notation.
 */
public class AbcTokenType implements TokenType {
	...
	public static AbcTokenType FIELD_COMPOSER = new AbcTokenType(
			"FIELD COMPOSER");
	/** The discography field token type : <TT>D:</TT>. */
	public static AbcTokenType FIELD_DISCOGRAPHY = new AbcTokenType(
			"FIELD DISCOGRAPHY");
	/** The elemskip field token type : <TT>E:</TT>. */
	public static AbcTokenType FIELD_ELEMSKIP = new AbcTokenType(
			"FIELD ELEMSKIP");
	...
	public static AbcTokenType FIELD_INFORMATION = new AbcTokenType(
			"FIELD INFORMATION");
	/** The default length field token type : <TT>L:</TT>. */
	public static AbcTokenType FIELD_DEFAULT_LENGTH = new AbcTokenType(
	...
	public static AbcTokenType FIELD_TRANSCRNOTES = new AbcTokenType(
			"FIELD TRANSCRNOTES");
	...
	public static AbcTokenType PARENTHESIS_OPEN = new AbcTokenType(
			"PARENTHESIS OPEN");
	/** The parenthesis close token type : character ')'. */
	public static AbcTokenType PARENTHESIS_CLOSE = new AbcTokenType(
			"PARENTHESIS CLOSE");
	...
	public static AbcTokenType KEY_ACCIDENTAL = new AbcTokenType(
			"KEY ACCIDENTAL");
	...
	public static AbcTokenType ANNOTATION_BEGIN = new AbcTokenType(
			"ANNOTATION BEGIN");
	public static AbcTokenType ANNOTATION_END = new AbcTokenType(
			"ANNOTATION END");
	...
	public static AbcTokenType MULTI_NOTE_BEGIN = new AbcTokenType(
			"MULTI NOTE BEGIN");
	public static AbcTokenType MULTI_NOTE_END = new AbcTokenType(
			"MULTI NOTE END");
	...
	public boolean isField() {
		return (equals(AbcTokenType.FIELD_AREA)
				...
				|| equals(AbcTokenType.FIELD_TRANSCRNOTES) || equals(AbcTokenType.FIELD_WORDS));
	}
