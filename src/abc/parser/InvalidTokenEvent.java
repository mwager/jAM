...
public class InvalidTokenEvent extends TokenEvent {
	 ...
	 * 
	 * @param source
	 *            The source that generates the event.
	 * @param token
	 *            The encountered invalid token.
	 * @param expectedTokenType
	 *            The type of token that was expected.
	 */
	public InvalidTokenEvent(Object source, Token token,
	 ...
	 *            The type of token that was expected.
	 */
	public InvalidTokenEvent(Object source, CharStreamPosition position,
			TokenType expectedTokenType) {
		super(source, null);
		m_expectedTokenType = expectedTokenType;
		m_position = position;
	 ...
	 * 
	 * @return The type of the token that was expected. The place where this
	 *         token was expected in the position returned by getPosition().
	 * @see #getPosition()
	 */
	...
	public String toString() {
		if (getToken() != null)
			return ("Expecting " + m_expectedTokenType.toString()
					+ " instead of " + getToken().getType().toString() + "("
