...
public interface TuneParserListenerInterface extends EventListener {
	 ...
	 * 
	 * @param event
	 *            An event describing the problem encountered by the parser.
	 */
	 ...
	 * 
	 * @param event
	 *            An event describing the valid token parsed.
	 */
	 ...
	 * 
	 * @param event
	 *            An event describing the invalid character found by the parser.
	 */
	 ...
	 * 
	 * @param tune
	 *            The tune that has just been parsed.
	 */
