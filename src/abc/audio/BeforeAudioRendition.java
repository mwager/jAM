...
/**
 * Utility class to prepare a {@link abc.notation.Tune.Music} object to be
 * rendered in audio output (MIDI or other)
 */
public class BeforeAudioRendition {
	...
	/**
	 * Transform tills, mordants, grupetto, arpeggio, staccato into multiple
	 * notes (and rests).
	 * 
	...
	/**
	 * Transforms <code>|: ... :|</code> into <code>2 * (...)</code>, repeat
	 * bars.
	 * 
	 * @param music
	 * @return
	...
	/**
	 * Apply dynamics by modifying notes' velocities by a percentage, e.g. +ff+
	 * apply 120%.
	 * 
	 * @param music
	 * @return
	...
	/**
	 * If <code>%%MIDI gchord ...</code> instruction(s) is(are) declared, create
	 * new voices for bass and chord accompaniments
	 * 
	 * @param music
	 * @return
	 */
