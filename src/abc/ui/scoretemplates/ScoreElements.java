...
/**
 * List of score elements, texts (title, composer...), notes, graces, clef,
 * accidental, time signature, decoration, slurs...
 * 
 */
public abstract class ScoreElements {
	...
	public static String toString(byte b) {
		...
		case TEXT_TITLE:
			return "title";
		case TEXT_TRANSCRNOTES:
			return "transcriber notes";
		case TEXT_WORDS:
			return "words";
		default:
			return "<unknown text field>";
		}
	}
}
