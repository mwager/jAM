...
public interface TextVerticalAlign {
	...
	/**
	 * First text line is at its base position, other lines are under
	 */
	public static final byte BASELINE = 1;
	/** First text line is under its base position */
	public static final byte TOP = 2;
	/** Text is vertically centered at its base position */
	public static final byte MIDDLE = 3;
	/** Last text line is at its base position */
