...
class JGraceNotePartOfGroup extends JNotePartOfGroup implements JGraceElement {
	...
	public JGraceNotePartOfGroup(Note noteValue, Clef clef, Point2D base,
			ScoreMetrics c) {
	...
	protected void onBaseChanged() {
		...
		int stemYBegin = (int) (displayPosition.getY() - glyphDimension
				.getHeight() / 2);

		stemUpBeginPosition = new Point2D.Double(noteX
				+ getMetrics().getGraceNoteWidth(), stemYBegin);
