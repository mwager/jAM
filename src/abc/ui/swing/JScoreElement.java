...
public interface JScoreElement {
	 ...
	 * 
	 * @return The music element represented by this graphical score element.
	 *         <TT>null</TT> if this graphical score element is not related to
	 *         any music element.
	 * @see MusicElement
	 */
	 ...
	 *         <TT>null</TT> is returned if no matching element has been found.
	 */
	 ...
	 * {@link #setAutoStem(boolean)} and {@link #setStemUp(boolean)}.
	 * 
	 * Known implementations are {@link JNoteElementAbstract} and
	 * {@link JGroupOfNotes}.
	 */
	public interface JStemmableElement {

		/**
		 * Returns if the stemmable element should follow stemming policy.
		 * 
		...
		/**
		 * Returns <TT>true</TT> if stem is up, <TT>false</TT> if down.
		 */
