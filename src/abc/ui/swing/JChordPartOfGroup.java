...
class JChordPartOfGroup extends JChord implements JGroupableNote {
	...
	public JChordPartOfGroup(MultiNote multiNote, Clef clef,
	...
	protected JChord createNormalizedChord(MultiNote mNote, ScoreMetrics mtrx,
			Point2D base) {
		// Is this the fastest chord resulting from the decomposition of the
		// original chord ?
	...
	public Point2D getStemBeginPosition() {
		if (m_normalizedChords != null)
			return ((JChordPartOfGroup) m_normalizedChords[0])
					.getStemBeginPosition();
		else
