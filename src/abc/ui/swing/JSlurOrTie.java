...
public class JSlurOrTie extends JScoreElementAbstract {
	...
	/**
	 * Yes I know, we should create a JNotesLink, but for now, here is the
	 * easiest place to store the control point for a tuplet, just above the
	 * tuplet number.
	 */
	 ...
	 *            The position :
	 *            <ul>
	 *            <li>{@link #POSITION_AUTO} by default, position will be
	 *            calculated
	 *            <li>{@link #POSITION_UNDER}
	 *            <li>{@link #POSITION_ABOVE}
	 *            </ul>
	 */
	...
	/**
	 * Does it care about stems to draw the link out of them ? <br>
	 * false by default
	 * 
	 * @param b
	 *            The outOfStems to set.
	 */
