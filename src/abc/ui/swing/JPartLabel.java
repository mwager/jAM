...
public class JPartLabel extends JText {
	...
	public Rectangle2D getBoundingBox() {
		...
		double y = getBase().getY()
				...
				- getMetrics().getNoteHeight() * 2 - framesize;
	...
	public double render(Graphics2D g2) {
		double labelSize = (double) getMetrics().getTextFontWidth(
				ScoreElements.PART_LABEL, getText());
		...
		float descent = g2.getFont()
				.getLineMetrics(getText(), g2.getFontRenderContext())
				.getDescent();
