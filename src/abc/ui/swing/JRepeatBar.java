...
class JRepeatBar extends JBar {
	...
	public double render(Graphics2D context) {
		...
		context.drawChars(ch, 0, ch.length, (int) (base.getX() + x + 1),
				(int) (topY + digitHeight * 1.5));
		// vertical line
		context.drawLine((int) (base.getX() + x - 1),
				(int) (base.getY() - staffHeight * 1.1),
				(int) (base.getX() + x - 1), (int) topY);
		// Horizontal line
		context.drawLine((int) (base.getX() + x - 1), (int) topY,
				(int) (base.getX() + x - 1 + staffWidth), (int) topY);
