...
public class MultiPartsDefinition extends RepeatedPartAbstract implements
		Cloneable {
	 ...
	 * 
	 * @param p
	 *            The part that has to be added to the multi part. This part can
	 *            be a simple <TT>Part</TT> or another </TT>MultiPart</TT>
