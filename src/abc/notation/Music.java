...
/**
 * A Music is a collection of {@link abc.notation.Voice}s containing
 * {@link MusicElement music elements} (notes, bars...), for a
 * {@link abc.notation.Part} of a {@link abc.notation.Tune} (part "A", "B",...
 * or at least the default part).
 */
public class Music implements Cloneable, Serializable {
	...
	public void append(Music music) {
		...
		if (music.m_partLabel != ' ') {
			...
			while (it.hasNext()) {
				((Voice) it.next())
						.addElement(new PartLabel(music.m_partLabel));
			}
		}
	...
	/**
	 * Maybe could be used...? add an element to all voices be sure to add it
	 * first in the voice, are last when all elements have been added...
	 * 
	 * @param element
	 */
	 ...
	 * @deprecated use {@link #getElementAtStreamPosition(int)} FIXME this is
	 *             specific to ABC format... should be elsewhere than in Music
	 *             object
	 */
	 ...
	 * @param offset
	 *            An offset in a char stream.
	 * @return The score element location at the specified offset. FIXME this is
	 *         specific to ABC format... should be elsewhere than in Music
	 *         object
	 */
	 ...
	 *            highest note.
	 * @return The highest note or multinote between two music elements.
	 *         <TT>null</TT> if no note has been found between the two music
	 *         elements.
	 * @throws IllegalArgumentException
	 *             Thrown if one of the music elements hasn't been found in the
	 *             music or if the <TT>elmtEnd</TT> param is located before the
	 *             <TT>elmntBegin</TT> param in the music.
	 * @deprecated use {@link #getVoice(byte)}.
	 *             {@link Voice#getHighestNoteBewteen(MusicElement, MusicElement)
	 *             getHighest...}
	 */
	 ...
	 * 
	 * @return The last note that has been added to this score. <TT>null</TT> if
	 *         no note in this score.
	 ...
	 *         if found. <TT>null</TT> if no note has been found between the two
	 *         music elements.
	 * @throws IllegalArgumentException
	 * @deprecated use {@link #getVoice(byte)}.
	 *             {@link Voice#getLowestNoteBewteen(MusicElement, MusicElement)
	 *             getLowest...}
	 */
	 ...
	 * @throws IllegalArgumentException
	 * @deprecated use {@link #getVoice(byte)}.
	 *             {@link Voice#getNotesBetween(MusicElement, MusicElement)
	 *             getNotesBetween...}
	 */
