 ...
 * </pre>
 * 
 * <b>NOTE:</b>The symbols T,H,L,M,P,S,O and ABC2.0 features and are not
 * supported by the abc4j 1.6 parser.
 */
public class Decoration extends SymbolElement implements Cloneable {
	...
	/**
	 * vertical line on the upper part of the staff, extending down to the
	 * centre line
	 */
	public static final byte MEDIUM_PHRASE = 38;

	/**
	 * vertical line on the upper part of the staff, extending 3/4 of the way
	 * down
	 */
	...
	public static byte convertToType(String str) {
		...
		if (str.equals("."))
			...
			type = REPEAT_LAST_BAR;
		else if (str.equals("repeatbar2"))
			type = REPEAT_LAST_TWO_BARS;
		return type;
	}
	...
	public String toString() {
		if (m_type == STACCATO)
			...
			return ("~");
		else if (m_type == UPBOW)
			return ("u");
		else if (m_type == DOWNBOW)
			return ("v");
		else if (m_type == TRILL)
			return ("T");
		else if (m_type == FERMATA)
			return ("H");
		else if (m_type == ACCENT)
			return ("L");
		else if (m_type == LOWERMORDENT)
			return ("M");
		else if (m_type == UPPERMORDENT)
			return ("P");
		else if (m_type == SEGNO)
			return ("S");
		else if (m_type == CODA)
			return ("O");
		return "";
