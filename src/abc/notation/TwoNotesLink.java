...
public class TwoNotesLink extends MusicElement implements Cloneable,
		Serializable {
	 ...
	 * 
	 * @return Returns the end of the two notes link. <TT>null</TT> if not
	 *         specified.
	 * @see #getStart()
	 */
	 ...
	 * 
	 * @param end
	 *            The note ending the relation between the two notes.
	 * @see #getEnd()
	 ...
	 * 
	 * @return Returns the start of the two notes link. <TT>null</TT> if not
	 *         specified.
	 * @see #getEnd()
	 */
	 ...
	 * 
	 * @param start
	 *            The note starting the relation between the two notes.
	 * @see #getStart()
