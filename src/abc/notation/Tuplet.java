...
public class Tuplet implements Cloneable, Serializable {
	...
	/**
	 * Creates a new tuplet composed of the specified notes. The total length of
	 * this tuplet will be equals to the totalRelativeLength * defaultLength.
	 * 
	 * @param notes
	 *            The <TT>NoteAbstract</TT> obejcts composing this tuplet,
	 *            encapsulated inside a <TT>Vector</TT>.
	 * @param totalRelativeLength
	 *            The total relative length of this tuplet multiplied by the
	 *            default relative length gives the total absolute length of
	 *            this tuplet.
	 */
	public Tuplet(Vector notes, short totalRelativeLength,
	 ...
	 * 
	 * @return The total relative length of this tuplet. The total relative
	 *         length of this tuplet multiplied by the default relative length
	 *         gives the total absolute length of this tuplet.
	 * @deprecated use totalDuration() instead. Reference to relative length
	 *             should be avoided in the API bacause this is only related to
	 *             the "abc world".
