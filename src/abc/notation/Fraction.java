...
public class Fraction extends MusicElement implements Cloneable, Serializable {
	 ...
	 *                Thrown if the denominator is equal to 0.
	 */
	...
	/**
	 * Multiplies this fraction by the specified fraction and returns the result
	 * as a float. This fraction remains unchanged.
	 * 
	 * @param fraction
	 *            A Fraction.
	 * @return The result of the multiplication of this fraction by the
	 *         specified one.
	 */
