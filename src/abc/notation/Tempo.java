...
public class Tempo extends MusicElement implements Cloneable {
	 ...
	 * length reference.
	 * 
	 * @param notesNbPerMinute
	 *            The number of quarter notes per minutes.
	 */
	 ...
	 * @param value
	 *            The number of reference lengths per minutes.
	 */
	 ...
	 * 
	 * @return The reference length used to express this tempo. Possible values
	 *         are <TT>Note.SIXTY_FOURTH</TT>, <TT>Note.THIRTY_SECOND</TT> ...
	 *         or <TT>Note.WHOLE</TT>.
	 */
	...
	/**
	 * Returns the number of note per minutes considering that those notes'
	 * length is the reference length.
	 * 
	 * @return the number of note per minutes considering that those notes'
	 *         length is the reference length.
	 */
