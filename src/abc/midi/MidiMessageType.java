...
/**
 * This interface exposes the types of midi messages created by the
 * <TT>abc.midi</TT> package
 */
public interface MidiMessageType {
	...
	/**
	 * The message type to flag which part of the abc notation is played during
	 * a tune playback.
	 * 
	...
	/**
	 * The message type to give a reference to the note index in the score that
	 * is being played during a tune playback.
	 */
