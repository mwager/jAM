...
public class TempoMessage extends MetaMessage {
	 ...
	 * 
	 * @param tempo
	 *            A tempo coming from an abc notation.
	 */
	public TempoMessage(Tempo tempo) {
		super();
		int nbOfQuarterNotesPerMinute = tempo
				.getNotesNumberPerMinute(Note.QUARTER);
		int microsecondsPerQuarterNote = MICRO_SECOND_NB_IN_ONE_MINUTE
				/ nbOfQuarterNotesPerMinute;
