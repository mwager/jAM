...
public class KeySignatureMessage extends MetaMessage {
	...
	public KeySignatureMessage(KeySignature key) {
		...
		/*
		 * FF 59 02 sf mi Key Signature Key Signature, expressed as the number
		 * of sharps or flats, and a major/minor flag. 0 represents a key of C,
		 * negative numbers represent 'flats', while positive numbers represent
		 * 'sharps'.
		 * 
