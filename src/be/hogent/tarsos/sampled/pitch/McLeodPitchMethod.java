...
public final class McLeodPitchMethod implements PurePitchDetector {
	 ...
	 * ignored.
	 */
	private static final double LOWER_PITCH_CUTOFF = 55.0; // Hz jAM edited to 55Hz (A1 http://www.phy.mtu.edu/~suits/notefreqs.html) from 80
	 ...
	 */
	public McLeodPitchMethod(final float audioSampleRate,
			final int audioBufferSize, final double cutoffMPM) {
