...
public final class Configuration {
			...
			if (userPreferences == null) {
				...
				for (final ConfKey configKey : ConfKey.values()) {
					...
					if (userPreferences.get(configKey.name(), null) == null) {
						final String defaultConfigVal = defaultConfProps
	...
	public static void set(final ConfKey key, final String value) {
		...
		try {
			final String actualValue = sanitizeConfiguredValue(key.name(),
					value);
	 ...
	 */
	private static String sanitizeConfiguredValue(final String key,
		...
		if (configuredValue != null) {
			...
			// separators!
			sanitizedValue = handleConfiguredDirectory(key,
	 ...
	 *         system.
	 */
	private static String handleConfiguredDirectory(final String key,
			final String configuredValue) {
	...
	private static boolean isActualConfiguredValue(final String key) {
		return !key.endsWith(DESCIPTION_SUFFIX)
				&& !key.endsWith(HUMAN_NAME_SUFFIX);
	}
