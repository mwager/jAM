...
public final class FileDrop {
	...
	public void makeDropTarget(final java.io.PrintStream out,
	...
	public static class Event extends java.util.EventObject {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -7224692781558820778L;
	...
	public static class TransferableObject implements
		...
		public TransferableObject(
				@SuppressWarnings("rawtypes") final Class dataClass,
