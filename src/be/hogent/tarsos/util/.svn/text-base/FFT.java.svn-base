...
public final class FFT {
	...
	public float modulus(final float[] data, final int index) {
		...
		final float modulus = data[realIndex] * data[realIndex]
	...
	private static class FloatFFT {
		...
		private static float[] computeTwiddleFactors(final int fftFrameSize,
				final int sign) {
		...
		private static void calc(final int fftFrameSize, final float[] data,
				final int sign, final float[] w) {
		...
		private static void calcF2E(final int fftFrameSize, final float[] data,
				final int i, final int nstep, final float[] w) {
			final int jmax = nstep;
			int t = i;
		...
		// complex operators
		private static void calcF4F(final int fftFrameSize, final float[] data,
				final int i, final int nstep, final float[] w) {
		...
		// Perform Factor-4 Decomposition with 3 * complex operators and 8 +/-
		// complex operators
		private static void calcF4I(final int fftFrameSize, final float[] data,
				final int i, final int nstep, final float[] w) {
			final int fftFrameSize2 = fftFrameSize << 1; // 2*fftFrameSize;
			// Factor-4 Decomposition
			int t = i;
		...
		// Perform Factor-4 Decomposition with 3 * complex operators and 8 +/-
		// complex operators
		private static void calcF4FE(final int fftFrameSize,
				final float[] data, final int i, final int nstep,
				final float[] w) {
			final int fftFrameSize2 = fftFrameSize << 1; // 2*fftFrameSize;
			// Factor-4 Decomposition
			int t = i;
		...
		// Perform Factor-4 Decomposition with 3 * complex operators and 8 +/-
		// complex operators
		private static void calcF4IE(final int fftFrameSize,
				final float[] data, final int i, final int nstep,
				final float[] w) {
			final int fftFrameSize2 = fftFrameSize << 1; // 2*fftFrameSize;
			// Factor-4 Decomposition
