...
public class FinaleStateAutomata {
	 ...
	 * 
	 * @param def
	 *            The definition of states and transitions of this automata.
	 */
	...
	/**
	 * Returns the transition that can be activated from this automata's current
	 * state with the specified character.
	 * 
	 * @param character
	 *            A character.
	 * @return The transition that can be activated from this automata's current
	 *         state. <TT>null</TT> is returned if no transition can be
	 *         activated with this character from the current state.
	 * @see #getCurrentState()
	 */
	...
	/**
	 * Returns a string that representes the list of all characters received by
	 * this finale state automata.
	 */
	...
	/**
	 * Initializes this state machine. The current state is back to the starting
	 * state and the received characters are initialized to none.
	 */
