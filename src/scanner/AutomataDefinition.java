...
/**
 * This class enables the description of automatas. Those definitions are
 * described using states and transitions between those states.
 * 
 * @see Transition
 * @see State
 */
public class AutomataDefinition {
	 ...
	 * 
	 * @param startingState
	 *            The starting state of this definition.
	 */
	...
	public AutomataDefinition union(AutomataDefinition def) {
		return new AutomataDefinition(m_startingState.union(def
				.getStartingState()));
	}
