...
/**
 * This interface should be implemented by any object that wants to listen to
 * scanner events thrown during characters stream scanning.
 */
public interface ScannerListenerInterface extends EventListener {
	 ...
	 * 
	 * @param event
	 *            Event containing all information about the token generated.
	 */
	 ...
	 * 
	 * @param evt
	 *            Event containing all information about the invalid character
	 *            found.
	 */
	 ...
	 * 
	 * @param line
	 *            The line that has just been processed.
	 */
