...
public class InvalidCharacterEvent extends EventObject implements
	 ...
	 * 
	 * @param source
	 *            The source that has detected the invalid character.
	 * @param character
	 *            The invalid character.
	 * @param position
	 *            The position where the invalid character has been detected.
	 */
	public InvalidCharacterEvent(Object source, char character,
